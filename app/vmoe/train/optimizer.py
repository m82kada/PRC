...
def create_optimizer(
  ...
  use_sam = "sam" in optim_kwargs and optim_kwargs["sam"]
  if "sam" in optim_kwargs:
    del optim_kwargs["sam"]
  ops = []
  ...
  res_opt = optax.chain(*ops)
  if use_sam:
    return optax.contrib.sam(res_opt, res_opt)
  return res_opt
