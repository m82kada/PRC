...
#  password.
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$dA6tCiDKzt6tL3ZRG7fAKg$6/jZXMQyS0xJKiVwI9uFPHE/U96wBLOhGgR/xSpaSlo'
...
#  Choices: any of ['sha512', 'blake2b', 'sha3_224', 'sha256', 'blake2s', 'sha224', 'sha3_384', 'md5', 'sha3_512', 'sha1', 'sha384', 'sha3_256']
#  Default: 'sha256'
